...
programming_languages = ["python",
                         ...
                         "cuda",
                         "android studio",
                         "flutterflow"]  # add programing languages here only it will get all the data in one csv

driver = webdriver.Chrome('/Users/sanskarjain/Project-Savo-by-The-Quantums/data/chromedriver')  # this is chrome you have to download it from google
